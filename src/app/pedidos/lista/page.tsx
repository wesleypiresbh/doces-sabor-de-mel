  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="flex justify-end mb-4">
        <Link href="/pedidos" className="ml-4 bg-amber-700 text-white px-4 py-2 rounded hover:bg-amber-800 transition-colors whitespace-nowrap">
          Novo Pedido
        </Link>
      </div>
              ...
              {pedidos.map((pedido) => (
                <tr key={pedido.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    ...
                    {/* Botão de Imprimir */}
                    <button
                      onClick={() => window.print()} // Exemplo simples de imprimir a página
