...
export default function NovoClientePage() {
  ...
  return (
    <div className="container mx-auto p-4 max-w-2xl">
      ...
      <h1 className="text-3xl font-bold text-center mb-8 text-amber-800">Cadastrar Novo Cliente</h1>
      ...
      <div className="bg-amber-50 p-8 rounded-lg shadow-md">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <div className="w-2/5">
              ...
              <input
                ...
                required // Telefone agora é obrigatório
              />
            </div>
          </div>
          <div>
          ...
          <div className="flex justify-end gap-4 pt-4">
            ...
            >
              {isLoading ? 'Salvando...' : 'Salvar Cliente'} {/* Texto dinâmico */}
            </button>
          </div>
        </form>
      </div>
